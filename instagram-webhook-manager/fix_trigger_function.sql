-- Fix trigger function to use instagram_conversations table
...
BEGIN
    ...
    -- instagram_conversations 테이블에 생성 또는 업데이트 (여기가 중요!)
    INSERT INTO instagram_conversations (  -- conversations가 아닌 instagram_conversations
        conversation_id,
        participant_1_id,
        participant_2_id,
        business_account_id,
